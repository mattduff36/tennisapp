...
import { handleUpdatePin } from "@/features/session/pin/pin-handlers";
...
export async function POST(request: Request) {
  try {
    ...
    const result = await handleUpdatePin(
    ...
    const notice = error instanceof Error ? error.message : "Could not update the PIN.";
